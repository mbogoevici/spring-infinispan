 ...
 * file containing default settings while simultaneously overriding select settings whenever special requirements
 * warrant this.<br/>
 ...
 * </p>
 * <p>
 * In addition to creating a <code>RemoteCacheManager</code> this <code>FactoryBean</code> does also control that
 * <code>RemoteCacheManagers</code>'s lifecycle by shutting it down when the enclosing Spring application context is
 * closed. It is therefore advisable to <em>always</em> use this <code>FactoryBean</code> when creating a
 * <code>RemoteCacheManager</code>.
 * </p>
 *
 ...
 * @see #destroy()
 */
public class InfinispanRemoteCacheManagerFactoryBean extends
		AbstractInfinispanRemoteCacheManagerBackedCacheManagerFactory implements FactoryBean<RemoteCacheManager>,
