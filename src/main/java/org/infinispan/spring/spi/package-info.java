 ...
 * {@link org.infinispan.spring.spi.SpringCache <code>org.infinispan.spring.SpringCache</code>}, there are two implementations
 * of <code>org.springframework.cache.CacheManager</code>:
 * <ol>
 *   <li>
 *     {@link org.infinispan.spring.spi.SpringEmbeddedCacheManager <code>org.infinispan.spring.SpringEmbeddedCacheManager</code>}
 *     and
 *   </li>
 *   <li>
 *     {@link org.infinispan.spring.spi.SpringRemoteCacheManager <code>org.infinispan.spring.SpringRemoteCacheManager</code>}
 *     and
 *   </li>
 * </ol>
