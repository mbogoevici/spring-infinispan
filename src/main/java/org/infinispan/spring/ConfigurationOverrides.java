...
public final class ConfigurationOverrides {
	...
	public void applyOverridesTo(final Configuration configurationToOverride) {
		...
		if (this.exposeJmxStatistics != null) {
			this.logger
					.debug("Overriding property [exposeJmxStatistics] with value [" + this.exposeJmxStatistics + "]");
		...
		if (this.eagerLockSingleNode != null) {
			this.logger
					.debug("Overriding property [eagerLockSingleNode] with value [" + this.eagerLockSingleNode + "]");
		...
		if (this.stateRetrievalMaxNonProgressingLogWrites != null) {
			this.logger.debug("Overriding property [stateRetrievalMaxNonProgressingLogWrites] with value ["
		...
		if (this.stateRetrievalRetryWaitTimeIncreaseFactor != null) {
			this.logger.debug("Overriding property [stateRetrievalRetryWaitTimeIncreaseFactor] with value ["
		...
		if (this.isolationLevelClass != null) {
			this.logger
					.debug("Overriding property [isolationLevelClass] with value [" + this.isolationLevelClass + "]");
		...
		if (this.consistentHashClass != null) {
			this.logger
					.debug("Overriding property [consistentHashClass] with value [" + this.consistentHashClass + "]");
		...
		if (this.useAsyncMarshalling != null) {
			this.logger
					.debug("Overriding property [useAsyncMarshalling] with value [" + this.useAsyncMarshalling + "]");
