...
public class ConfigurationOverridesTest {
	...
	/**
	 * Test method for {@link org.infinispan.spring.embedded.ConfigurationOverrides#applyOverridesTo(org.infinispan.config.Configuration)}.
	 */
	@Test
	public final void configurationOverridesShouldOverrideDeadlockSpinDetectionDurationPropIfExplicitlySet()
		...
		assertEquals(
				...
				expectedDeadlockSpinDetectionDuration, defaultConfiguration.getDeadlockDetectionSpinDuration());
	}
	...
	public final void configurationOverridesShouldOverrideEnableDeadlockDetectionPropIfExplicitlySet() throws Exception {
		...
		assertEquals(
				...
				expectedEnableDeadlockDetection, defaultConfiguration.isEnableDeadlockDetection());
	}
	...
	public final void configurationOverridesShouldOverrideUnsafeUnreliableReturnValuesPropIfExplicitlySet()
		...
		assertEquals(
				...
				expectedUnsafeUnreliableReturnValues, defaultConfiguration.isUnsafeUnreliableReturnValues());
	}
	...
	public final void configurationOverridesShouldOverrideReplQueueMaxElementsPropIfExplicitlySet() throws Exception {
		...
		assertEquals(
				...
				expectedReplQueueMaxElements, defaultConfiguration.getReplQueueMaxElements());
	}
	...
	public final void configurationOverridesShouldOverrideInvocationBatchingEnabledPropIfExplicitlySet()
		...
		assertEquals(
				...
				expectedInvocationBatchingEnabled, defaultConfiguration.isInvocationBatchingEnabled());
	}
	...
	public final void configurationOverridesShouldOverrideAlwaysProvideInMemoryStatePropIfExplicitlySet()
		...
		assertEquals(
				...
				expectedAlwaysProvideInMemoryState, defaultConfiguration.isAlwaysProvideInMemoryState());
	}
	...
	public final void configurationOverridesShouldOverrideLockAcquisitionTimeoutPropIfExplicitlySet() throws Exception {
		...
		assertEquals(
				...
				expectedLockAcquisitionTimeout, defaultConfiguration.getLockAcquisitionTimeout());
	}
	...
	public final void configurationOverridesShouldOverrideEvictionWakeUpIntervalPropIfExplicitlySet() throws Exception {
		...
		assertEquals(
				...
				expectedEvictionWakeUpInterval, defaultConfiguration.getEvictionWakeUpInterval());
	}
	...
	public final void configurationOverridesShouldOverrideEvictionThreadPolicyPropIfExplicitlySet() throws Exception {
		...
		assertEquals(
				...
				expectedEvictionThreadPolicy, defaultConfiguration.getEvictionThreadPolicy());
	}
	...
	public final void configurationOverridesShouldOverrideEvictionThreadPolicyClassPropIfExplicitlySet()
		...
		assertEquals(
				...
				EvictionThreadPolicy.PIGGYBACK, defaultConfiguration.getEvictionThreadPolicy());
	}
	...
	public final void configurationOverridesShouldOverrideTransactionManagerLookupClassPropIfExplicitlySet()
		...
		assertEquals(
				...
				expectedTransactionManagerLookupClass, defaultConfiguration.getTransactionManagerLookupClass());
	}
	...
	public final void configurationOverridesShouldOverrideTransactionManagerLookupPropIfExplicitlySet()
		...
		assertEquals(
				...
				expectedTransactionManagerLookup, defaultConfiguration.getTransactionManagerLookup());
	}
	...
	public final void configurationOverridesShouldOverrideCacheLoaderManagerConfigPropIfExplicitlySet()
		...
		assertSame(
				...
				expectedCacheLoaderManagerConfig, defaultConfiguration.getCacheLoaderManagerConfig());
	}
	...
	public final void configurationOverridesShouldOverrideStateRetrievalTimeoutPropIfExplicitlySet() throws Exception {
		...
		assertEquals(
				...
				expectedStateRetrievalTimeout, defaultConfiguration.getStateRetrievalTimeout());
	}
	...
	public final void configurationOverridesShouldOverrideStateRetrievalLogFlushTimeoutPropIfExplicitlySet()
		...
		assertEquals(
				...
				expectedStateRetrievalLogFlushTimeout, defaultConfiguration.getStateRetrievalLogFlushTimeout());
	}
	...
	public final void configurationOverridesShouldOverrideStateRetrievalNumRetriesPropIfExplicitlySet()
		...
		assertEquals(
				...
				expectedStateRetrievalNumRetries, defaultConfiguration.getStateRetrievalNumRetries());
	}
	...
	public final void configurationOverridesShouldOverrideUseLazyDeserializationPropIfExplicitlySet() throws Exception {
		...
		assertEquals(
				...
				expectedUseLazyDeserialization, defaultConfiguration.isUseLazyDeserialization());
	}
